...
const PATHS = {
  iconPath: "/assets/brand/icons/32x32.png",
  flashPath: "/assets/status-question.png",
};

test("mac normal icon uses the brand source at 16pt", () => {
  const nativeImage = makeNativeImage();
  loadTrayNormalIcon({ nativeImage, platform: "darwin", ...PATHS });

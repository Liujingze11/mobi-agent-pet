...
describe("quota ring — bounds placement", () => {
  ...
  it("moves a four-coin Orbit clear of fixed permission bubbles", () => {
    // Real default-theme geometry from the review repro: right-bottom Clawd,
    // bubbleFollowPet=false, with two permission bubbles.
    ...
    const avoids = [
      ...
      { x: 1092, y: 742, width: 340, height: 150 }, // permission
    ];
    const r = computeQuotaRingBounds({
      hitRect: pet,
      workArea,

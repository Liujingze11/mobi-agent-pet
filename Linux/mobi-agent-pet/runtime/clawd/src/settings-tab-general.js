...
(function initSettingsTabGeneral(root) {
  ...
  function render(parent) {
    ...
    // Appearance stays first so language is easy to find. System & startup
    // follows it so the pet visibility and login switches are easy to reach.
    ...
    parent.appendChild(helpers.buildSection(t("sectionSystemStartup"), [
      helpers.buildSwitchRow({
        key: "petHidden",
        labelKey: "rowHidePet",
        descKey: "rowHidePetDesc",
        onToggle: ({ nextRaw }) => window.settingsAPI.setPetHidden(nextRaw),
      }),
      helpers.buildSwitchRow({
        key: "openAtLogin",

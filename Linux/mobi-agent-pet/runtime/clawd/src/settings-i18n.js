...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      aboutProductName: "Clawd on Desk",
      ...
      rowQuotaRingEnabledDesc: "On a pet click, show per-source quota rings (rolling + weekly windows) beside the pet. Independent of the Session HUD; details stay in Sessions.",
      ...
      shortcutLabelOpenDashboard: "Ctrl/Cmd + Click pet: Open Sessions",
      ...
      rowHidePet: "Hide pet",
      rowHidePetDesc: "Hide the pet until you show it again from Settings.",
      ...
      rowHideBubblesDesc: "Hide permission and notification bubbles across Clawd.",
      rowBubbleFollow: "Bubbles follow Clawd",
      rowBubbleFollowDesc: "Place permission and notification bubbles next to the pet instead of the screen corner.",
    ...
    zh: {
      ...
      rowHideBubbles: "隐藏气泡",
      rowHideBubblesDesc: "隐藏 Clawd 的权限和通知气泡。",
      rowBubbleFollow: "气泡跟随 Clawd",
      rowBubbleFollowDesc: "把权限气泡和通知气泡放在桌宠旁边，而不是屏幕角落。",
      ...
      rowTextScale: "文字大小",
      rowTextScaleDesc: "缩放本屏幕上气泡、会话 HUD、会话面板和设置页的文字。每块屏幕分别记忆；不影响桌宠本体。",
    ...
    "zh-TW": {
      ...
      rowHideBubblesDesc: "隱藏 Clawd 的權限和通知對話框。",
      rowBubbleFollow: "對話框跟著 Clawd",
      rowBubbleFollowDesc: "把權限和通知對話框放在桌寵旁邊，不放螢幕角落。",
      ...
      rowTextScale: "文字大小",
      rowTextScaleDesc: "縮放本螢幕上氣泡、工作階段 HUD、工作階段面板與設定頁的文字。每個螢幕分別記憶；不影響桌寵本體。",
    ...
    ko: {
      ...
      rowQuotaRingEnabledDesc: "펫을 클릭하면 소스별 쿼터 링(현재 창 + 주간)을 펫 옆에 표시합니다. 세션 HUD와 독립적이며, 상세는 세션 대시보드에 있습니다.",
      ...
      rowHidePet: "펫 숨기기",
      rowHidePetDesc: "펫을 숨깁니다. 설정에서 다시 표시할 수 있습니다.",
      ...
      rowHideBubblesDesc: "Clawd의 권한 및 알림 말풍선을 숨깁니다.",
      rowBubbleFollow: "말풍선이 Clawd를 따라다님",
      rowBubbleFollowDesc: "권한 및 알림 말풍선을 화면 구석 대신 펫 옆에 표시합니다.",
    ...
    ja: {
      ...
      rowQuotaRingEnabledDesc: "ペットをクリックすると、ソース別のクォータリング（現在の枠 + 週間）をペット横に表示します。セッション HUD とは独立しており、詳細は セッションダッシュボードにあります。",
      ...
      rowHidePet: "ペットを隠す",
      rowHidePetDesc: "ペットを隠します。設定から再表示できます。",
      ...
      rowHideBubblesDesc: "Clawd の権限・通知の吹き出しをまとめて非表示にします。",
      rowBubbleFollow: "吹き出しが Clawd に追従",
      rowBubbleFollowDesc: "権限と通知の吹き出しを画面端ではなくペットの隣に表示します。",

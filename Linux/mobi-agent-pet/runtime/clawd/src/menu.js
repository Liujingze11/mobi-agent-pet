...
// src/login-item.js and the Settings effect. The tray opens Settings for this control.
...
module.exports = function initMenu(ctx) {
  ...
  function setTrayIcon(icon) {
    if (!ctx.trayRuntime || typeof ctx.trayRuntime.setIcon !== "function") return Promise.resolve();
    return ctx.trayRuntime.setIcon(icon);
  }

...
export function seedDefaults(db: Database.Database): void {
  ...
  const defaultAchievements = [
    ...
    { key: 'first_project_done', name: '首个项目达成', description: '第一个项目累计工作时长超过1小时', icon: '🏁', category: 'special',
      condition: JSON.stringify({ type: 'project_completed', threshold: 1, threshold_seconds: 3600 }) },

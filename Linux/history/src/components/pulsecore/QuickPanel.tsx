...
export default function QuickPanel({ onStartWork, onStartLearning, onOpenGui, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/40 animate-fade-in" onClick={onClose}>
      <div className="w-72 bg-slate-800/95 backdrop-blur-lg rounded-xl border border-slate-700 shadow-2xl p-4 text-white text-sm" onClick={e => e.stopPropagation()}>
